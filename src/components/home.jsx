...
export default function Home(){
    ...
    <div data-scroll-section className="min-vh-100 container-fluid m-0 p-0" id="home">
        ...
        <div className="row">
            <StaticImage className={"avatar-image mx-auto shadow-lg"} style={{borderRadius: '50%'}} transformOptions={{cropFocus: "attention"}} placeholder={"blurred"} quality={100} object-fit={"contain"} layout={"fixed"} resizeMode={"cover"} width={250} height={250} src={"../images/avatar2.jpg"} alt={"avatar"} />
        </div>
      </div>
    </>
    )
