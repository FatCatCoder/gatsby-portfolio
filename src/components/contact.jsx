            ...
            <div className="container">
                ...
                <div className="col-12 col-md-6 col-lg-4 col-xl-4 mx-auto text-center">
                    <a className="btn btn-github text-decoration-none col-4" href="https://github.com/FatCatCoder">
                        <Lottie options={defaultOptions(LottieAnimeGithub)} isClickToPauseDisabled={true} height={'6rem'} width={'6rem'} style={{filter: 'invert(100%)'}} />
                    </a>
                    <a className="btn btn-linkedin text-decoration-none col-4" href="https://www.linkedin.com/in/christian-claudeaux-006479225">
                        <Lottie options={defaultOptions(LottieAnimeLinkedin)} isClickToPauseDisabled={true} height={'6rem'} width={'6rem'} style={{filter: 'invert(100%)'}} />
                    </a>
                    <a className="btn btn-linkedin text-decoration-none col-4" href="https://twitter.com/CClaudeaux">
                        <Lottie options={defaultOptions(LottieAnimeTwitter)} isClickToPauseDisabled={true} height={'6rem'} width={'6rem'} style={{filter: 'invert(100%)'}} />
                    </a>
                </div>
            </div>
        </div>
        <div className="stained-glass row position-absolute bottom-0 mb-2 text-center">
